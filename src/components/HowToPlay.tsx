    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <ol className="list-decimal pl-5 space-y-2">
          ...
          <li>
            After guessing all 5 quotes, you will be able to see exactly how you
            performed.
          </li>
        ...
        <footer className="flex flex-col gap-2">
          ...
          <div>
            ...
            , belonging to &copy;{" "}
            <span className="font-bold">Fontainebleau</span>. All rights belong
          ...
          <div>
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li>
                <span className="font-bold">Fontainebleau</span>, for creating
                such an amazing game
              </li>
              <li>
                <span className="font-bold">You</span>, for trying this game out
              </li>
            </ul>
          </div>
